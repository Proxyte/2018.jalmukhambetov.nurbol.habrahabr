...
public abstract class LocalSessionFactory implements BeanReplacer, HasAfterInject, DataSourceInterface {
  ...
  @Bean
  public JdbcBlog getJdbcBlog() {
    return jdbcblog;
  }

  private JdbcBlog jdbcblog = null;
  ...
  public void afterInject() throws Exception {
    ...
    jdbcblog = new JdbcBlog(dataSource, transactionManager);
